---
title: "CASE-CONTROL STUDIES and META-ANALYSIS FOR ODDS RATIOS"  
...
-   Not all comparative studies between groups of patients and healthy
    individuals are case-control stydies
...
-   The figures below are from Yuwadee Ngamwong et. al., Additive
    Synergism between Asbestos and Smoking in Lung Cancer Risk: A
    Systematic Review and Meta-Analysis,
    (<https://doi.org/10.1371/journal.pone.0135798> )

![](Meta_allA.png)

Meta analysis forest plot: Summary odds ratio of lung cancer for
asbestos-exposed and smoking compared with not asbestos-exposed and
non-smoking.
...
(A) Summary odds ratio of asbestos-exposed and non-smoking compared with
    not asbestos-exposed and non-smoking

(B) Summary odds ratio of non-exposure to asbestos and smoking compared
    with not asbestos-exposed and non-smoking.
...
# EXAMPLE OF META ANALYSIS - CASE CONTROL STUDIES

## Data needed

-   A couple of studies - no definite rule but the more the better

-   Number of cases by exposure;, i.e.

    -   number of cases in exposed

    -   number of cases in non-exposed

    -   number of non-cases in exposed

    -   number of non-cases in non-exposed

-   Bacille Calmette Guerin (BCG) is the most widely used vaccination in
    the world. Developed in the 1930s and made of a live, weakened
    ...
    These two variables will be used **to investigate and perhaps
    explain any heterogeneity among the studies**.

    -   Cases and non cases: TB and non TB

    -   Exposure BCG vaccination
...
A funnel plot shows the observed effect sizes or outcomes on the x-axis
against some measure of precision of the observed effect sizes or
outcomes on the y-axis. In the absence of publication bias and
...
-   Randomisation
    ...
    -   Ensures that known and unknown confounders are similarly
